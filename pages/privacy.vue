  ...
  <div class="home">
    ...
    <v-row class="form-content">
      <v-col cols="12">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to FEDAM, No 10, Temitope House, Market
              Street,.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to FEDAM, accessible from
              <a
        ...
        <ul>
          <li>
            <p>By email: fredrickksola@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:
              <a
                href="fedam.com/contact"
                rel="external nofollow noopener"
                target="_blank"
                >fedam.com/contact</a
              >
          ...
          <li>
            <p>By phone number: 08110546625</p>
          </li>
        </ul>
      </v-col>
    </v-row>
